...
namespace Matchmaker.Patterns
{
    ...
    internal class CachingPattern<TInput, TMatchResult> : Pattern<TInput, TMatchResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// The disctionary which holds this pattern's cache.
        /// </summary>
        private readonly Dictionary<TInput, MatchResult<TMatchResult>> cache =
            new Dictionary<TInput, MatchResult<TMatchResult>>();
