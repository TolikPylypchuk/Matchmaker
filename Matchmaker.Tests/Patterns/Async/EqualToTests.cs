...
namespace Matchmaker.Patterns.Async
{
    ...
    public class EqualToTests
    {
        ...
        {
            Action action = () => AsyncPattern.EqualTo<string>(
        ...
        {
            Action action = () => AsyncPattern.EqualTo(
                () => throw new AssertionFailedException("Lazy EqualTo is not lazy"),
        ...
        {
            Action action = () => AsyncPattern.EqualTo(x, (IEqualityComparer<string>)null);
        ...
        {
            Action action = () => AsyncPattern.EqualTo(x, (string)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        public void EqualToShouldThrowIfComparerIsNullAndDescriptionIsNotNull(
            ...
            NonNull<string> description)
        {
            Action action = () => AsyncPattern.EqualTo(x, null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.EqualTo(x, StringEqualityComparer, null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.EqualTo((Func<Task<string>>)null, StringEqualityComparer);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.EqualTo((Func<Task<string>>)null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
