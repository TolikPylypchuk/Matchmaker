...
namespace Matchmaker.Patterns.Async
{
    ...
    public class LessThanTests
    {
        ...
        {
            Action action = () => AsyncPattern.LessThan<string>(
        ...
        {
            Action action = () => AsyncPattern.LessThan(
                () => throw new AssertionFailedException("Lazy LessThan is not lazy"),
                StringComparer);
            action.Should().NotThrow<AssertionFailedException>();
        }
        ...
        {
            Action action = () => AsyncPattern.LessThan(x, (IComparer<string>)null);
        ...
        {
            Action action = () => AsyncPattern.LessThan(x, (string)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        public void LessThanShouldThrowIfComparerIsNullAndDescriptionIsNotNull(
            ...
            NonNull<string> description)
        {
            Action action = () => AsyncPattern.LessThan(x, null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.LessThan(x, StringComparer, null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.LessThan((Func<Task<int>>)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.LessThan((Func<Task<string>>)null, StringComparer);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.LessThan((Func<Task<string>>)null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
