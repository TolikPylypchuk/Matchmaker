...
namespace Matchmaker.Patterns.Async
{
    ...
    public class GreaterOrEqualTests
    {
        ...
        [Property(Arbitrary = new[] { typeof(Generators) })]
        public Property LazyGreaterOrEqualWithDescriptionShouldNeverReturnNull(Task<string> x, NonNull<string> description)
            => (AsyncPattern.GreaterOrEqual(() => x, description.Get) != null).ToProperty();
        ...
        [Property(Arbitrary = new[] { typeof(Generators) })]
        public Property GreaterOrEqualWithComparerShouldHaveSpecifiedDescription(Task<string> x, NonNull<string> description)
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual<string>(
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual(
                () => throw new AssertionFailedException("Lazy GreaterOrEqual is not lazy"),
                StringComparer);
            action.Should().NotThrow<AssertionFailedException>();
        }
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual(x, (IComparer<string>)null);
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual(x, (string)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        public void GreaterOrEqualShouldThrowIfComparerIsNullAndDescriptionIsNotNull(
            ...
            NonNull<string> description)
        {
            Action action = () => AsyncPattern.GreaterOrEqual(x, null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual(x, StringComparer, null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual((Func<Task<int>>)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual((Func<Task<string>>)null, StringComparer);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => AsyncPattern.GreaterOrEqual((Func<Task<string>>)null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
