...
namespace Matchmaker.Linq
{
    ...
    public class AsyncBindTests
    {
        ...
        {
            Action action = () => ((IAsyncPattern<string, string>)null).Bind(binder);
        ...
        public void BindPatternWithDescriptionShouldThrowIfPatternIsNull(
            ...
            NonNull<string> description)
        {
            Action action = () => ((IAsyncPattern<string, string>)null).Bind(binder, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => pattern.Bind((Func<string, IAsyncPattern<string, int>>)null);
            action.Should().Throw<ArgumentNullException>();
        }
