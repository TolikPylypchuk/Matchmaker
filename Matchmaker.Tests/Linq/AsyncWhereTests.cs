...
namespace Matchmaker.Linq
{
    ...
    public class AsyncWhereTests
    {
        ...
        {
            Action action = () => ((IAsyncPattern<string, string>)null).Where(predicate);
        ...
        public void WherePatternWithDescriptionShouldThrowIfPatternIsNull(
            ...
            NonNull<string> description)
        {
            Action action = () => ((IAsyncPattern<string, string>)null).Where(predicate, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => pattern.Where((Func<string, bool>)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        public void WherePatternWithDescriptionShouldThrowIfPredicateIsNull(
            ...
            NonNull<string> description)
        {
            Action action = () => pattern.Where((Func<string, bool>)null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action action = () => pattern.Where((Func<string, Task<bool>>)null);
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        public void AsyncWherePatternWithDescriptionShouldThrowIfPredicateIsNull(
            ...
            NonNull<string> description)
        {
            Action action = () => pattern.Where((Func<string, Task<bool>>)null, description.Get);
            action.Should().Throw<ArgumentNullException>();
        }
